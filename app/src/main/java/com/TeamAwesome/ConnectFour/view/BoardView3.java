...
import static com.TeamAwesome.ConnectFour.controller.GamePlayController3.COLS;
import static com.TeamAwesome.ConnectFour.controller.GamePlayController3.ROWS;

public class BoardView3 extends RelativeLayout {

    private static final String TAG = GamePlayController3.class.getName();
    private GameRules mGameRules;
    private GamePlayController3 mListener;
    ...
    public BoardView3.PlayerInformation mPlayer1; //changed it to be public
    public BoardView3.PlayerInformation mPlayer2;
    ...
    public BoardView3(Context context) {
        super(context);
        init(context);
    }

    public BoardView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BoardView3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initialize(GamePlayController3 gamePlayController, @NonNull GameRules gameRules) {
    ...
    public void resetBoard() {
        ...
        showWinStatus(BoardLogic3.Outcome.NOTHING, null);
    }
     ...
     */
    public void showWinStatus(@NonNull BoardLogic3.Outcome outcome, @NonNull ArrayList<ImageView> winDiscs) {
        if (BuildConfig.DEBUG) {
            Log.e(TAG, outcome.name());
        }
        if (outcome != BoardLogic3.Outcome.NOTHING) {
