...
import static com.TeamAwesome.ConnectFour.controller.GamePlayController1.COLS;
import static com.TeamAwesome.ConnectFour.controller.GamePlayController1.ROWS;

public class BoardView1 extends RelativeLayout {
    ...
    public BoardView1(Context context) {
        super(context);
        init(context);
    }

    public BoardView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public BoardView1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initialize(GamePlayController1 gamePlayController, @NonNull GameRules gameRules) {
    ...
    public void resetBoard() {
        ...
        showWinStatus(BoardLogic1.Outcome.NOTHING, null);
    }
     ...
     */
    public void showWinStatus(@NonNull BoardLogic1.Outcome outcome, @NonNull ArrayList<ImageView> winDiscs) {
        if (BuildConfig.DEBUG) {
            Log.e(TAG, outcome.name());
        }
        if (outcome != BoardLogic1.Outcome.NOTHING) {
